  ...
  getAssetManifest() {
    return {
      textures: [
        ...
        {
          name: "nightSky",
          path: "./assets/NightSkyHDRI003_8K/NightSkyHDRI003.png",
        },
        ...
        // Monster textures
        {
          name: "monsterBaseColor",
          path: "./assets/monster/textures/BaseColor.png",
        },
      ],
      ...
      models: [
        ...
        {
          name: "maleModel",
          path: "./assets/male/model/male.fbx",
          type: "fbx",
        },
        {
          name: "femaleModel",
          path: "./assets/female/model/female.fbx",
          type: "fbx",
        },
        ...
        {
          name: "monsterModel",
          path: "./assets/monster/model/monster.fbx",
          type: "fbx",
        },
      ...
      animations: [
        ...
        // Monster animations (renamed files)
        { name: "monsterIdle", path: "./assets/monster/animations/idle.fbx" },
        { name: "monsterWalk", path: "./assets/monster/animations/walk.fbx" },
        { name: "monsterRun", path: "./assets/monster/animations/run.fbx" },
        {
          name: "monsterAttack",
          path: "./assets/monster/animations/attack.fbx",
        },
        {
          name: "monsterAttack1",
          path: "./assets/monster/animations/attack1.fbx",
        },
      ],

      audio: [
        { name: "background", path: "./assets/audio/ambient.mp3" },
        { name: "buttonClick", path: "./assets/audio/click.mp3" },
        { name: "gameStart", path: "./assets/audio/start.mp3" },
        { name: "footstep", path: "./assets/audio/footstep.mp3" },
        { name: "run", path: "./assets/audio/run.wav" },
        { name: "deathScream", path: "./assets/audio/death.mp3" },
        { name: "wallHit", path: "./assets/audio/bump.mp3" },
        { name: "ghostMoan", path: "./assets/audio/moan.mp3" },
        { name: "ghostWhisper", path: "./assets/audio/whisper.mp3" },
        { name: "heartbeat", path: "./assets/audio/heart.mp3" },
        { name: "impact", path: "./assets/audio/hit.mp3" },
      ],
    };
  }
    ...
    try {
      ...
      for (const tex of manifest.textures) {
        try {
          ...
          console.warn(
            `[AssetLoader] Could not load texture ${tex.name}:`,
            e.message,
          );
        }
      ...
      for (const model of manifest.models) {
        try {
          ...
          console.warn(
            `[AssetLoader] Could not load model ${model.name}:`,
            e.message,
          );
        }
      ...
      for (const anim of manifest.animations) {
        try {
          ...
          console.warn(
            `[AssetLoader] Could not load animation ${anim.name}:`,
            e.message,
          );
        }
      ...
      for (const aud of manifest.audio) {
        try {
          ...
          console.warn(
            `[AssetLoader] Could not load audio ${aud.name}:`,
            e.message,
          );
        }
